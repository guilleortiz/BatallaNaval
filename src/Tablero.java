			 ...
			 while (localizacionEncontrada==false) {
					...
					if (ColocarBarcoEnNuevaPos(f,c,tamaño,direccion)) {
						localizacionEncontrada=true;
						 System.out.println("Coordenadas "+f+","+c+" direcc: " +(direccion==1 ? "horizontal":"vertical")+" para barco "+tamaño+" valida");
						 System.out.println("");
					} else{
						System.out.println("Coordenadas "+f+","+c+" direcc: " +(direccion==1 ? "horizontal":"vertical")+" para barco "+tamaño+" no valida ");
				...
				tamaño=i;
				 ...
				 while (localizacionEncontrada==false) {
					...
					if (ColocarBarcoEnNuevaPos(f,c,tamaño,direccion)) {
						...
						+(direccion==1 ? "horizontal":"Vertical")+
						" para barco "+tamaño+" encontrada");
						System.out.println("");
